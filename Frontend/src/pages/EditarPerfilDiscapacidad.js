...
import '../components/RegistroDiscapacidad.css';

function EditarPerfilDiscapacidad() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`http://localhost:5000/api/discapacidad/${usuarioId}`, {
      ...
      .then((data) => {
        ...
        navigate(`/profileDiscapacidad/${usuarioId}`); // Redirigir al perfil del usuario
      })
      .catch((error) => console.error('Error:', error));
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="registro-container">
      <div className="header">
        ...
        <h1>Editar Perfil de Discapacidad</h1>
      ...
      {activeStep === 2 && (
        <div className="form-section">
          ...
          >
            ...
            {/* Aquí puedes agregar todas las opciones de estados que necesites */}
          </select>
          <input
            type="text"
            name="codigo_postal"
          ...
          <div className="file-upload-container">
            <label htmlFor="descripcionApoyo">Realiza una breve descripción del apoyo que se requiere</label>
            <textarea
              id="descripcionApoyo"
...
export default EditarPerfilDiscapacidad;
