...
function RegistroNino() {
  ...
  const requiredFieldsByStep = {
    1: ["nombre", "apellidoPaterno", "apellidoMaterno", "fechaNacimiento", "edad", "sexo", "curp", "nivelEstudios"],
    ...
    4: ["antecedentesPatologicos", "serviciosSalud", "informeMedico", "historialMedico", "certificadosTratamientosPaliativos", "descripcionApoyo"],
    5: ["comprobanteDomicilio", "curpDocumento", "documentoIdentidad", "declaracionImpuestos", "comprobanteIngresos", "cartaAntecedentesNoPenales", "referenciasPersonalesProfesionales", "fotoPerfil"]
    };
