...
import './RegistroTerceraEdad.css';

const RegistroTerceraEdad = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (['nombre', 'apellidoPaterno', 'apellidoMaterno', 'ocupacion','domicilio', 'colonia', 'municipio', 'referencia'].includes(name)) {
    ...
    if (name === 'edad') {
      formattedValue = Math.max(60, Math.min(120, Number(value) || ''));
    }
    if (name === 'curp') {
    ...
    <form onSubmit={handleSubmit}>
      <div className="registro-container">
        <div className="header">
          ...
          <h1>Registro para Tercera Edad</h1>  
      ...
      {activeStep === 0 && (
        <div className="form-section">
          <h2>Datos Personales de la Persona de la Tercera Edad</h2>
...
<h3>Documentación de la persona de la Tercera Edad</h3>
...
export default RegistroTerceraEdad;
